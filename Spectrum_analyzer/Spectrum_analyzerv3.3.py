...
class RamanFitterApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Cold Atom Raman Analysis - v5.0 (Named Peaks)")
        ...
        self.entry_peak_names.insert(0, "Left, Right") # Default example
        ...
        # --- 结果表格 (Updated Columns) ---
        self.tree_frame = ttk.Frame(self.frame_left)
        self.tree_frame.pack(fill=tk.BOTH, expand=True)
        columns = ("Name", "Center", "Width", "Area") # Changed Peak # to Name
        ...
        self.tree.column("Center", width=60, anchor="center")

...
atomic interferometer and displays the free-expansion growth of the transverse atom-cloud size.
...
The desktop interface is implemented with Tkinter and Matplotlib. The GUI is organized into three
main groups of controls and three output tabs.
...
\subsection{Top-right Action Bar}

The interface now places the main execution controls in the top-right corner of the application
window. This keeps the numerical input column focused on parameters while reserving a dedicated
location for simulation management:
